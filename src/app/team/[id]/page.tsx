  ...
  return (
    <div className="max-w-3xl">
      ...
      <PageHeader
        ...
        description={`${WORKOUT_TYPE_SHORT[pieceGroup.type]} · ${formatDate(pieceGroup.date)} · ${
      ...
      <Reveal>
        <Card className="overflow-hidden">
            ...
            <table className="w-full text-left text-sm">
              ...
              <RevealTableBody>
                {pieceGroup.workouts.map((w, i) => (
                  <RevealRow key={w.id} className="border-b border-border transition-colors last:border-0 hover:bg-background">
          ...
          <RevealList className="divide-y divide-border sm:hidden">
            {pieceGroup.workouts.map((w, i) => (
              <RevealListItem key={w.id} className="flex items-center gap-3 px-4 py-3">
